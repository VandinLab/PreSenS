...
public:
    ...
    static void initialize(size_t fixedSeed);
    ...
    */
    ...
    blaze::DynamicVector<double> multivariate_normal(const blaze::DynamicVector<double> &mean,
                                                     const blaze::DynamicMatrix<double> &cov);

    double get_normal_value(double mean, double stddev);
